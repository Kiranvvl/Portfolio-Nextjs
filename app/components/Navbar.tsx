              ...
              <div className="flex justify-between w-full">
                <div className="flex items-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium ">
                      Nakkeeran
                      <span className="text-teal-500 ">Soundarrajan</span>
                    </h1>
                  </Link>
                </div>
                <div className="hidden  sm:ml-6 sm:flex sm:space-x-8 sm:items-center">
                  <Link
                    ...
                    className={`${
                      pathname === '/'
                        ? 'border-teal-300 dark:text-white h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'
